...
final class ResteasyGitLabClient implements GitLabClient {
    ...
    @Override
    public MergeRequestApprovalStatus getMergeRequestApprovalStatus(MergeRequest mr) {
        return api.getMergeRequestApprovalStatus(mr.getProjectId(), mergeRequestIdProvider.apply(mr));
    }
